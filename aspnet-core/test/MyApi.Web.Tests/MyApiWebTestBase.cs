...
{
    public abstract class MyApiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyApiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyApiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyApiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyApiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyApiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyApiDbContext, Task<T>> func)
        {
            T result;
