...
namespace MyApi.Migrations
{
    ...
    [Migration("20230720201637_create-entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyApi.EmailCodes.EmailCode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyApi.Treinos.Treino", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("AnosTreino")
                        .HasColumnType("int");

                    b.Property<int>("CondicionamentoTreino")
                        .HasColumnType("int");

                    b.Property<int>("DiasTreino")
                        .HasColumnType("int");

                    b.Property<bool>("Finalizado")
                        .HasColumnType("bit");

                    b.Property<int>("HorariosTreino")
                        .HasColumnType("int");

                    b.Property<int>("ObjetivoTreino")
                        .HasColumnType("int");

                    b.Property<string>("OutraInformacao")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyApi.EmailCodes.EmailCode", b =>
                {
                    b.HasOne("MyApi.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyApi.Treinos.Treino", b =>
                {
                    b.HasOne("MyApi.Authorization.Users.User", "User")
                        .WithOne("Treino")
                        .HasForeignKey("MyApi.Treinos.Treino", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
